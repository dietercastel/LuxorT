...
#TODO: fix angle
#textoutlines(".jl", Point(-117, 40) + offsetPoint, angle=0.7 * pi / 4, :fillpreserve, halign=:center, valign=:middle)
...
# text("Wormhole.", Point(-55, -60) * borderScale, angle=0.7 * pi / 4, halign=:center, valign=:middle)
#textoutlines("Wormhole.", Point(-55, -60), :fillpreserve, angle=0.7 * pi / 4, halign=:center, valign=:middle)
